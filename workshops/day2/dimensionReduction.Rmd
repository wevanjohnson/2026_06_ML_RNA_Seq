...
## Grouping variable and a filtered count matrix (shared by all three methods)
group <- as.factor(meta_data$disease_status)
counts_filt <- counts[rowSums(counts) > 100, ]
...
## ---- Heatmap of DEGs ----
mat <- as.matrix(assay(se_hivtb, "log_counts_cpm"))[deseq_top, ]
